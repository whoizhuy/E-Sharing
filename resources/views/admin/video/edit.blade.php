...
@section('content')
<h1 style="text-align: center;">Cập nhật Video "{{ $item_video->name }}"</h1>

<form method="post" action="{{ route('video.update',['id_course'=>$item_course->id,'id' => $item_video->id]) }}" enctype="multipart/form-data">
@csrf
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" id="inputName" class="form-control" name="name" value="{{ $item_video->name }}">
              </div>
              <input type="hidden" value="{{ $item_course->id }}" name="course_id">
              <div class="form-group">
                <label for="inputdesc">Mô tả</label>
                <textarea id="inputdesc" class="form-control"  name="desc" rows="4">{{ $item_video->desc }}</textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <img src="{{ $item_video->image_path }}" id="img_preview" style="width:200px;">
              </div>
              <div class="form-group">
